...
//         </div>
//         {/* Mobile grid with 4 cards */}
//         <div className="flex flex-col md:hidden justify-center items-center mt-10 w-[100%]">
//           <img src="/seamlessCard1.svg" alt="Card 1" className="w-full" />
//           <img src="/seamlessCard2.svg" alt="Card 2" className="w-full" />
//           <img src="/seamlessCard3.svg" alt="Card 3" className="w-full" />
//           <img src="/seamlessCard4.svg" alt="Card 4" className="w-full" />
//         </div>
